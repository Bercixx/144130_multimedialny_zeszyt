    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Edytuj użytkownika</h3>
            </div>
			<?php echo form_open('uzytkownicy/edit/'.$uzytkownik['id']); ?>
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						<label for="email" class="control-label"><span class="text-danger">*</span>Email</label>
						<div class="form-group">
							<input type="text" name="email" value="<?php echo ($this->input->post('email') ? $this->input->post('email') : $uzytkownik['email']); ?>" class="form-control" id="email" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="imie" value="<?php echo ($this->input->post('imie') ? $this->input->post('imie') : $uzytkownik['imie']); ?>" class="form-control" id="imie" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="nazwisko" value="<?php echo ($this->input->post('nazwisko') ? $this->input->post('nazwisko') : $uzytkownik['nazwisko']); ?>" class="form-control" id="nazwisko" />
