<div class="row">
    <div class="col-md-12">
      	<div class="box box-success">
			...
			<?php echo form_open('opiekun/zajecia_dodaj/'); ?>
			<div class="box-body">
				<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
                            <?= form_dropdown('dzien_tyg',['Pon'=>'Poniedziałek','Wt'=>'Wtorek','Śr'=>'Środa','Czw'=>'Czwartek','Pt'=>'Piątek'],$this->input->post('dzien_tyg'), 'class="form-control" id="dzien_tyg"') ?>
