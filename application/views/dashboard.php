        ...
        <div class="box">
            <div class="box-header">
                ...
                <?php elseif (czyRodzic()): ?>
                    ...
                    <a class="btn btn-app" href="<?= site_url('kalendarz/index') ?>">
                    ...
                    <a class="btn btn-app" href="<?= site_url('rodzic/opiekunowie_lista') ?>">
                        <i class="fa fa-users"></i> Opiekunowie
                    </a>
                    <a class="btn btn-app" href="<?= site_url('rodzic/dziecko') ?>">
                        <i class="fa fa-user"></i> Dziecko
                    </a>
                ...
                <?php elseif (czyOpiekun()): ?>
                    ...
                    <a class="btn btn-app" href="<?= site_url('opiekun/uwagi') ?>">
                        <i class="fa fa-exclamation"></i> Uwagi
                    </a>
